...
public class PropertyController {
    ...
    public ResponseEntity<ResponseWrapper<PropertyResponse>> createProperty(@Valid @RequestBody PropertyRequest request) {
    ...
    @GetMapping("/search")
    public ResponseEntity<ResponseWrapper<List<PropertyResponse>>> searchProperties(
        ...
        List<PropertyResponse> properties = propertyService.searchProperties(city, country, minPrice, maxPrice, bedrooms, status);
    ...
    public ResponseEntity<ResponseWrapper<PropertyResponse>> updateProperty(
        ...
        return ResponseEntity.ok(ResponseWrapper.success("Property updated", propertyService.updateProperty(id, request)));
    }
