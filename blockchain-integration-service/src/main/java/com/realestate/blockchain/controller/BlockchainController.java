...
public class BlockchainController {
    ...
    public ResponseEntity<ResponseWrapper<Map<String, Object>>> executeTransaction(
        ...
        return ResponseEntity
                .ok(ResponseWrapper.success("Transaction submitted", blockchainService.executeTransaction(request)));
    }

    @GetMapping("/contract/{address}")
    @Operation(summary = "Get smart contract state")
    public ResponseEntity<ResponseWrapper<Map<String, Object>>> getContractState(@PathVariable String address) {
