...
public class GlobalExceptionHandler {
        ...
        public ResponseEntity<ErrorResponse> handleDataIntegrityViolationException(
                ...
                String message = "Database error: Value already exists or constraint violation";
                if (ex.getCause() != null && ex.getCause().getMessage() != null) {
                        if (ex.getCause().getMessage().contains("users_email_key")) {
                                message = "Email already exists";
                        } else if (ex.getCause().getMessage().contains("users_wallet_address_key")) {
